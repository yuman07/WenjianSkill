            ...
            {showInfo && (
              <div className="absolute right-0 top-8 w-72 bg-white rounded-lg shadow-lg border border-gray-200 p-4 z-50">
                <p className="text-sm text-gray-700 leading-relaxed">
                  当前版本(<button onClick={() => open("https://github.com/yuman07/WenjianSkill")} className="text-blue-500 hover:text-blue-600 cursor-pointer">v{__APP_VERSION__}</button>)已完美适配渡劫期之前所有神通。渡劫期神通暂沿用大乘期神通升级消耗数据，可能存在偏差，待获取准确数据后更新
                </p>
