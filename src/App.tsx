            ...
            {showInfo && (
              <div className="absolute right-0 top-8 w-72 bg-white rounded-lg shadow-lg border border-gray-200 p-4 z-50">
                <p className="text-sm text-gray-700 leading-relaxed">
                  当前版本(<button onClick={() => open("https://github.com/yuman07/WenjianSkill")} className="text-blue-500 hover:text-blue-600 cursor-pointer">v{__APP_VERSION__}</button>)适配到渡劫版本，但缺少渡劫神通极一到极五的数据，之后会补充
                </p>
