...
4. **金色书页充足** — 分两层检查。首先全局盈余（各商店书页 + 狗粮池 - 本体需求）>= 金色总需求；然后逐个技能检查：该技能金色需求 <= 其他商店盈余 + 同商店可用金色，其中同商店可用金色 = 池 + 其他同商店技能盈余 − max(0, 同商店本体缺口 − 该技能自身盈余)。自身盈余虽不能直接作为自己的金色，但可通过同商店转换覆盖其他技能的本体缺口——这部分缺口无需再由池/他人盈余填补，因此公式里要抵消。此抵消项若遗漏会把可行性检查变得过于保守
